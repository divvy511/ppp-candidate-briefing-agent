...
- outreach_hook: EXACTLY ONE SENTENCE — write the literal words the consultant speaks when the candidate picks up the phone. Not consultant instructions. Not advice on how to approach the call. The actual sentence. Embed: (1) a specific firm event, (2) PPP mandate framing, (3) why this candidate fits. Structure: "Given [specific event], I thought it worth reaching out — we're engaged on a mandate with [firm type] looking to [role], and your background in [specific expertise] is exactly the profile they have in mind." BAD (do NOT do this): "Acknowledge the merger complexity and position the call as a market mapping discussion..." GOOD: "Given Perpetual's failed KKR demerger and the ongoing three-way business separation, I thought it worth reaching out — we're engaged on a mandate with a mid-tier active manager looking to build out their distribution leadership, and your experience managing national distribution through sustained corporate disruption is exactly the profile they have in mind."
...
- current_role.tenure_years: NEVER write 0.0 unless research confirms the candidate started within the last 6 months. When exact start dates are unverified, use a conservative estimate (e.g. 2.0, 3.5) based on context clues — appointment announcements, press releases, career progression patterns. Note the uncertainty in career_narrative with "tenure estimated at ~X years [UNVERIFIED]". A rough estimate is far more useful to a recruiter than 0.0.
- outreach_hook: ONE sentence only. Before submitting, check: did you write exactly one sentence? Is it the words the consultant speaks aloud, not instructions about how to call? If not, rewrite it.
""".strip()
